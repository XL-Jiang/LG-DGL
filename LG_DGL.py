...
"""
from Module import *
from L_DGL import L_DGL
from G_DGL import G_DGL

#### Local to  Global Multi-scale Fusion and Classification
class LG_DGL(nn.Module):
    def __init__(self, input_dim1,input_dim2, input_dim3,hidden_dim,topk, phd_dim,num_classes,num_heads, num_time,window_size, kernel_size,cls_token='max', readout='baro'):
        ...
        self.L_MDGL1= L_DGL(hidden_dim,num_time,window_size, kernel_size)
        self.L_MDGL2 = L_DGL(hidden_dim, num_time, window_size, kernel_size)
        self.L_MDGL3 = L_DGL(hidden_dim, num_time, window_size, kernel_size)
        # Global Multi-scale Dynamic Graph Learning
        self.G_MDGL= G_DGL(input_dim1,input_dim2,input_dim3, hidden_dim,topk, window_size,num_heads, num_time,cls_token=cls_token, readout=readout)
